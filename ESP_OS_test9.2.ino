...
const char* ssid = "ESP32_OS";
const char* password = "12345678";

WebServer server(80);

// Track pin modes (pin_no -> mode)
std::map<int, String> activePins;
// Track buzzer pins
std::map<int, bool> buzzerPins;
// Track DHT11 sensor pins
std::map<int, DHT*> dhtPins;
// Track LDR sensor pins
std::map<int, bool> ldrPins;
// Track ultrasonic sensor pairs (sensorName -> {trig, echo})
std::map<String, int> ultrasonicTrig;
std::map<String, int> ultrasonicEcho;
// Track IR receiver pins
std::map<int, IRrecv*> irPins;
// Store last received IR code per pin
...
int i2cSDAPin = -1;
int i2cSCLPin = -1;
// I2C LCD address and object
uint8_t lcdAddress = 0x27;
bool lcdReady = false;
LiquidCrystal_I2C* lcd = nullptr;

// Global variables for code/ script executor
...
<head>
<meta charset="UTF-8">
<title>EMBER_OS Premium v1.4</title>
<style>
...
// Script executor endpoint — receives and parses the code/ script
void handleExecute() {
...
// Script runner — called every loop(), non-blocking
void runScript() {
